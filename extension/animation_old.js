...
const addImageToQueue = (url) => {
  queue[counter++] = url // Use counter as the key and increment it
  console.log('New image added to queue:', url)
  if (isGridMode) {
    addImageToGrid(url) // Add the image to the grid if in grid mode
  }
}
